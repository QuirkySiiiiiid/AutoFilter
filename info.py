...
OWNER_ID = environ.get('OWNER_ID', '2090517919')
...
PICS = (environ.get('PICS', 'https://graph.org')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://i.ibb.co/sJtbbCY/New-Project-1-EDC3459.png")
MELCOW_VID = environ.get("MELCOW_VID", "https://i.ibb.co/sJtbbCY/New-Project-1-EDC3459.png")
SPELL_IMG = environ.get("SPELL_IMG", "https://telegra.ph/Isjw-07-27")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://telegra.ph/Isjw-07-27'))
CODE = (environ.get('CODE', 'https://telegra.ph/Ksk-07-27'))
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2090517919').split()]
...
AI_LOGS = int(environ.get("AI_LOGS", "-1002310660714")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of Bot ]

#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '-1002432527808').split()]
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', '@Anime106_Request_bot') # owner username without @

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002121937308')) #Log channel id ( make sure bot is admin )
DUMP_CHNL = int(environ.get('DUMP_CHNL', '-1002276035934'))
...
BOT_USERNAME = environ.get("BOT_USERNAME", "SaitamaMovieBot")
BOT_NAME = environ.get("BOT_NAME", "SaitamaMovieBot")
BOT_ID = environ.get("BOT_ID", "7024349409")
S_GROUP = environ.get('S_GROUP', "Moviess_Group")
S_CHANNEL = environ.get('S_CHANNEL', "https://t.me/Moviess_Ok")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+Awbl4ndpOd85YjZl')
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : @🇲 🇴 🇻 🇮 🇪 🇸 🇸 _🇴 🇰 ')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+Awbl4ndpOd85YjZl') #Support group link ( make sure bot is admin )
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002174163101')).split()]
